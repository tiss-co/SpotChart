...
class ViewController: UIViewController {
    ...
    func setupChartView(){
        ...
        lineSpotChart.lineChartView.xAxis.gridColor = UIColor.lightGray
        lineSpotChart.lineChartView.xAxis.gridLineDashLengths = [4,4]
        lineSpotChart.lineChartView.rightAxis.gridColor = UIColor.lightGray
        lineSpotChart.lineChartView.rightAxis.gridLineDashLengths = [4,4]
